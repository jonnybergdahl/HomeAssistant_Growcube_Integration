...
class GrowcubeDataCoordinator(DataUpdateCoordinator):
    ...
    def on_disconnected(self, host: str) -> None:
        ...
        self.hass.states.async_set(DOMAIN + '.' + self.entity_id, STATE_UNAVAILABLE)
